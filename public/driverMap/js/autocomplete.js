...
function AutocompleteDirectionsHandler(map) {
    ...
    this.setupPlaceChangedListener(pickupAutocomplete, 'PICK');
    this.setupPlaceChangedListener(destinationAutocomplete, 'DEST');

    this.map.controls[google.maps.ControlPosition.LEFT_TOP].push(originInput);
    this.map.controls[google.maps.ControlPosition.LEFT_TOP].push(pickupInput);
...
AutocompleteDirectionsHandler.prototype.setupPlaceChangedListener = function(autocomplete, mode) {
    ...
    autocomplete.addListener('place_changed', function() {
        ...
        if (mode === 'ORIG') {
            ...
            me.pickupPlaceId = place.place_id;
            getGeocode(me.pickupPlaceId);
        } else {
...
AutocompleteDirectionsHandler.prototype.route = function() {
    ...
    if (airportPlaceId.includes(this.originPlaceId) || airportPlaceId.includes(this.destinationPlaceId)) {
      ...
      var waypts = [];
      waypts.push({
        location: {placeId: this.pickupPlaceId},
        stopover: true
      });
